...
static const char *synccmd[]   = { "/home/terack/2bwm/changecompositor.sh", NULL };
///--Custom foo---///
...
static key keys[] = {
    ...
    {  XCB_MOD_MASK_1,              XK_Tab,        focusnext,         {.i=TWOBWM_FOCUS_NEXT}},
    {  XCB_MOD_MASK_1 |SHIFT,        XK_Tab,        focusnext,         {.i=TWOBWM_FOCUS_PREVIOUS}},
    // Kill a window
    {  XCB_MOD_MASK_1,              XK_q,          deletewin,         {}},
    // Resize a window
    ...
    // Move a window
    {  MOD |SHIFT|CONTROL,              XK_k,          movestep,          {.i=TWOBWM_MOVE_UP}},
    {  MOD |SHIFT|CONTROL,              XK_j,          movestep,          {.i=TWOBWM_MOVE_DOWN}},
    {  MOD |SHIFT|CONTROL,              XK_l,          movestep,          {.i=TWOBWM_MOVE_RIGHT}},
    {  MOD |SHIFT|CONTROL,              XK_h,          movestep,          {.i=TWOBWM_MOVE_LEFT}},
    ...
    // Maximize and move
    // vertically left
    {  MOD ,        XK_h,          maxhalf,           {.i=TWOBWM_MAXHALF_VERTICAL_LEFT}},
    // vertically right
    {  MOD ,        XK_l,          maxhalf,           {.i=TWOBWM_MAXHALF_VERTICAL_RIGHT}},
    // horizontally left
    {  MOD ,        XK_j,          maxhalf,           {.i=TWOBWM_MAXHALF_HORIZONTAL_BOTTOM}},
    // horizontally right
    {  MOD ,        XK_k,          maxhalf,           {.i=TWOBWM_MAXHALF_HORIZONTAL_TOP}},
    ...
    {  CONTROL |XCB_MOD_MASK_1,              XK_t,          start,             {.com = termcmd}},
    {  MOD ,              XK_b,          start,             {.com = browcmd}},
    {  MOD |SHIFT,              XK_s,          start,             {.com = scrncmd}},
    {  MOD ,              XK_e,          start,             {.com = filecmd}},
    {  0x000000,              0x1008ff16,          start,             {.com = synccmd}},
